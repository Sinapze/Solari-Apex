...
//A basic axe class that extends itemPickaxe from default minecraft
public class ItemEvoliteAxe extends ItemAxe{
	
	public ItemEvoliteAxe(String unlocalizedName)
	{
		super(ItemEvoliteIngot.EVOLITE); //we call the axe constructor with our evolite material
